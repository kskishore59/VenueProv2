...
- Name: tenant-operations.spec.ts >> Standard Tenant Workspace Operations >> should handle Leads workflow: creation, updating status, and converting to booking
- Location: tests\e2e\tenant-operations.spec.ts:22:3
...
Call log:
  ...
  - waiting for locator('h1')
    11 × locator resolved to <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-950 tracking-tight leading-[1.1] font-display">…</h1>
