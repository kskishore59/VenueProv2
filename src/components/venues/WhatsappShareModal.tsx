...
import { X, MessageSquare, Copy, Send } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4 z-50 overflow-y-auto">
        <div 
          className="relative bg-white border border-gray-200 rounded-3xl w-full max-w-xl shadow-2xl flex flex-col p-6 overflow-hidden animate-scale-up"
